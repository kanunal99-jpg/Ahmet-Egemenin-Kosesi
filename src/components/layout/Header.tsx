  ...
  return (
    <header className="sticky top-0 z-40 border-b border-slate-200 bg-white/95 backdrop-blur-md shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between min-h-[520px] py-3 gap-4">
              ...
              {user ? (
                <>
                  <button
                    ...
                    className="relative w-[500px] h-[500px] rounded-[3rem] bg-slate-900 flex items-center justify-center text-white font-black text-5xl overflow-hidden ring-2 ring-slate-200 shadow-2xl hover:ring-blue-400 transition-all disabled:cursor-wait shrink-0"
                  ...
                  >
                    ...
                    <span className="absolute inset-x-0 bottom-0 h-16 bg-slate-950/75 flex items-center justify-center">
                      {avatarUploading ? <Loader2 className="w-10 h-10 animate-spin" /> : <Camera className="w-10 h-10" />}
                    </span>
                  </button>
                  <input
                    ref={avatarInputRef}
