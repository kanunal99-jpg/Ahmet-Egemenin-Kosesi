  ...
  return (
    <header className="sticky top-0 z-40 border-b border-slate-200 bg-white/95 backdrop-blur-md shadow-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between min-h-64 py-3 gap-4">
              ...
              {user ? (
                <>
                  <button
                    ...
                    className="relative w-[350px] h-[250px] rounded-3xl bg-slate-900 flex items-center justify-center text-white font-black text-4xl overflow-hidden ring-2 ring-slate-200 shadow-xl hover:ring-blue-400 transition-all disabled:cursor-wait shrink-0"
